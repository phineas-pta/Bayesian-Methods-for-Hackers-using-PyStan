...
import numpy as np, tensorflow as tf, arviz as az, matplotlib.pyplot as plt, tensorflow_probability as tfp
...
def mdl_batch():
	...
	rate = tf.gather([lamb1, lamb2], indices = tf.cast(tau*n <= tf.range(n), dtype="int32")) # vectorize ifelse
